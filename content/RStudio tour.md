...
# Why is coding (in R) worth it?

R and other similar languages (like Python) allow a **reproducible and shareble** record of data analysis. This is not possible with other analysis methods like Excel and SPSS.

R (and Python) are both open access, so you can keep using them for free for ever.
...
The <strong>History</strong> tab allows you to see the commands that you have entered.

</li>

<li style="margin-left:2em; padding-bottom: 0;">

The <strong>Environement</strong> tab allows you to see what data, vectors, and other values R can access. When you read in data, look here to make sure you actually read your data into RStudio.
...
<strong>Plot</strong> is where you can view your plot.

</li>

<li style="margin-left:2em">

<strong>Packages</strong> is where you can view the list of all the installed packages.

</li>

<li style="margin-left:2em; padding-bottom: 0;">

In <strong>Help</strong>, you can can browse the built-in help system of R, which is super helpful.
